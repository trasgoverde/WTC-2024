...
import { WTC-Collectibles } from "../typechain-types"
import { SignerWithAddress } from "@nomiclabs/hardhat-ethers/signers"
import { loadFixture } from "@nomicfoundation/hardhat-network-helpers"
import { expect } from "chai"

describe("WTC Collectibles", function () {
  async function baseFixture(): Promise<{
    contract: WTC-Collectibles
    owner: SignerWithAddress
    otherAddresses: SignerWithAddress[]
  }> {
    const ContractFactory = await ethers.getContractFactory("WTC-Collectibles")
